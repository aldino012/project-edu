...
// PERBAIKAN: Menghapus kurung kurawal {} pada useTableAngka
...
const TableAngka = () => {
  ...
  // Update filteredData ketika dataAngka berubah
  useEffect(() => {
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-white p-6 rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-slate-100 gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1 font-medium">
            Total:{" "}
            <span className="text-blue-600 font-bold">{dataAngka.length}</span>{" "}
            Angka terdaftar
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex justify-center items-center gap-3">
                          <button
                            onClick={() =>
                              navigate(`/admin/angka/edit/${item.id}`)
                            }
